# Participant 1: Inventory Request System Prompts
...
```text
I want to build a inventory request app. Where should I start?
```
...
```text
Make inventory requests save in Supabase and show again.
```
...
```text
This is wrong. Make it match the inventory request app, keep it simple, and fix it.
```
