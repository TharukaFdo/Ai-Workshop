# Participant 1: Internship Application Tracker Prompts
...
```text
I want to build a internship application tracker app. Where should I start?
```
...
```text
Make internship applications save in Supabase and show again.
```
...
```text
This is wrong. Make it match the internship application tracker app, keep it simple, and fix it.
```
