...
- book catalog fields and availability status
- borrow and return lending workflow
- librarian-only book management and member borrowing ownership
...
| Protected action |  |  |  |  |  |  |  |  |  |
| Secondary feature |  |  |  |  |  |  |  |  |  |
| Case-specific: book catalog fields and availability status |  |  |  |  |  |  |  |  |  |
| Case-specific: borrow and return lending workflow |  |  |  |  |  |  |  |  |  |
| Case-specific: librarian-only book management and member borrowing ownership |  |  |  |  |  |  |  |  |  |
| UI/manual usability |  |  |  |  |  |  |  |  |  |
| Security posture |  |  |  |  |  |  |  |  |  |
| Testing evidence |  |  |  |  |  |  |  |  |  |
| Maintainability |  |  |  |  |  |  |  |  |  |
...
Context:
This is Library Lending System, a React, Express, Node.js, and MySQL app using React, Node.js/Express, and local MySQL.
