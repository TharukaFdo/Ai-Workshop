...
- project title, category, supervisor, and status fields
- supervisor feedback workflow
- student ownership and supervisor-only approval
...
| Protected action |  |  |  |  |  |  |  |  |  |
| Secondary feature |  |  |  |  |  |  |  |  |  |
| Case-specific: project title, category, supervisor, and status fields |  |  |  |  |  |  |  |  |  |
| Case-specific: supervisor feedback workflow |  |  |  |  |  |  |  |  |  |
| Case-specific: student ownership and supervisor-only approval |  |  |  |  |  |  |  |  |  |
| UI/manual usability |  |  |  |  |  |  |  |  |  |
| Security posture |  |  |  |  |  |  |  |  |  |
| Testing evidence |  |  |  |  |  |  |  |  |  |
| Maintainability |  |  |  |  |  |  |  |  |  |
...
```text
Revise for Student Project Tracker. Keep React, Express, Node.js, and MySQL, small scope, student, supervisor, project submission, validation, backend role access, database-backed login, add or edit supervisor feedback and approve or reject projects, filter projects by supervisor, category or status, automated checks, and fix the issue. Do only the current stage.
```
## Error Prompt
